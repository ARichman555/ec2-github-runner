...
| `subnet-id`                                                                                                                                                                  | Required if you use the `start` mode and do not specify the `vvpc-id`. This cannot be used with `vpc-id`.     | VPC Subnet Id. <br><br> The subnet should belong to the same VPC as the specified security group.                                                                                                                                                                                                                                     |
| `vpc-id`                                                                                                                                                                  | Required if you use the `start` mode and do not specify the `subnet-id`. This will attempt to launch the instance in any subnet in the provided VPC. This cannot be used with `subnet-id`.      | VPC Id. <br><br> The VPC should be the same VPC as the specified security group.                                                                                                                                                                                                                                     |
